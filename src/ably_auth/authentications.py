...
from .serializers import JwtTokenGenerator
...
class BaseJSONWebTokenAuthentication(BaseAuthentication):
    ...
    def authenticate(self, request):
        ...
        payload = generator.decode(jwt_value)
    ...
    def authenticate_credentials(self, payload):
        ...
        try:
            ...
            raise exceptions.AuthenticationFailed('존재하지 않는 유저입니다.')

        if not user.is_activated:
            raise exceptions.AuthenticationFailed('비활성화 된 계정입니다.')
